          ...
          <Box component="form" noValidate onSubmit={handleSubmit(submitForm)} sx={{ mt: 3 }}>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                ...
                />
                <p className='text-danger' style={{fontSize: '14px'}}>{errors?.firstName?.message}</p>
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  required
                  ...
                  {...register('lastName')}
                />
                <p className='text-danger' style={{fontSize: '14px'}}>{errors?.lastName?.message}</p>
              </Grid>
              <Grid item xs={12}>
                <TextField
                  required
                  ...
                  {...register('email')}
                />
                <p className='text-danger' style={{fontSize: '14px'}}>{errors?.email?.message}</p>
              </Grid>
              <Grid item xs={12}>
                <TextField
                  required
